...
### 0. cd final_task . 
### Финальное задание содержится в папке final_task. Путь файлов ниже указан относительно корневой директории папки final_task, то есть после выполнения команды cd final_task .
